...
(function ($) {
	"use strict";
      ...
      if (href != '#nav' && (typeof _target !== "undefined") && (typeof _target.offset() !== "undefined")) {
        ...
        $('body,html').animate({scrollTop: (position - $('header.headshrunk').height() + 2) }, 500, 'swing');
	    }
	    false;
	  });
    ...
    $.fn.headshrinker = function (options) {
        var defaults = {
            ...
            shrinkMenuTop: "49px", // adjust top positioning of the flyout menu
            menuSwitch: 1011, // aimed at the mobile experience, when menu is this width, convert to hamburger
        ...
        return this.each(function () {
            ...
            function headShrinker() {
				...
				$window.load(function() {
					...
					jQuery(headShrink).css( 'padding-top' , 0 );
					jQuery(headShrink).css( 'padding-bottom' , 0 );
				...
				function shrinkMenu() {
					...
					if ( shrinkMenu === true || windowWidth <= menuSwitch ) {
						...
						jQuery('.headshrinker-reveal' , headShrink).on( "click" , function(e) {
							...
							jQuery('.headshrinker-menu' , headShrink).toggle(200);
				      ...
				      if (href != '#nav' && (typeof _target !== "undefined") && (typeof _target.offset() !== "undefined")) {
						...
						jQuery('.headshrinker-menu-line' , headShrink).on( "click" , function(e) {
